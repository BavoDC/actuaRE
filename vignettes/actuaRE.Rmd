...
what the `tweedieGLMM` function does! Nonetheless, even with the initial estimates the fitting process does take some time.

```{r, eval = FALSE}
fitGLMM = tweedieGLMM(y ~ x1 + (1 | cluster / subcluster), tweedietraindata, weights = wt, verbose = TRUE)
```
